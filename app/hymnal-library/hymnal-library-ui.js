      ...
      <section class="section hymnal-library-settings">
        <div class="song-header">
          <div>
            ...
            <p class="muted">Organise hymn books, language editions, and imports. Christ in Song and SDA Hymnal remain separate books.</p>
          </div>
            ...
            <article class="hymnal-book-card">
              <header class="hymnal-book-header">
                <div>
                  ...
                  <span class="muted">${escapeHtml(book.shortTitle || book.hymnBookId)}${book.isBuiltIn ? " · Built-in" : ""}${book.isEditable === false ? " · Read-only" : ""}</span>
                </div>
                <span class="status-pill ${book.isBuiltIn ? "ready" : "awaiting"}">${(book.editions || []).length} edition(s)</span>
              </header>
                ...
                ${(book.editions || []).map((edition) => `
                  <li class="hymnal-edition-row">
                    <div>
                      ...
                      <span class="muted">${escapeHtml(edition.editionId)} · ${escapeHtml(edition.sourceFileName || edition.sourceType || "")}</span>
                    </div>
                    <div class="hymnal-edition-meta">
