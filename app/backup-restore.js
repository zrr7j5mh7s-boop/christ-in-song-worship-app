(function () {
  ...
  function buildReadme(manifest) {
    const lines = [
      ...
      `Application version: ${manifest.appVersion || "unknown"}`,
      `Build: ${manifest.buildNumber != null ? manifest.buildNumber : "unknown"}`,
  ...
  async function buildArchive(componentIds, options = {}) {
    ...
    const manifest = {
      ...
      appVersion: call("getAppVersion") || "1.0.0-rc.1",
      buildNumber: call("getBuildNumber") || 1,
      releaseChannel: call("getReleaseChannel") || "rc",
